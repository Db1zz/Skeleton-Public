...
class NpcContainer {
  public:
    ...
    // in npc_container_.
    virtual bool AddNpc(const string& npc_name,
    ...
    inline auto begin()  {
      return npc_container_.begin();
    }
    // Returns iterator of the end npc_container_.
    inline auto end()  {
      return npc_container_.end();
    }
